  ...
  DescriptorSetManager& descriptorSetManager)
{
    ...
    auto data = (u32*)buffer.AllocationInfo().pMappedData + offsetCount * sizeof(u32);
    *data     = materialData.color;

    auto perObjectBufferInfo = vkinit::DescriptorBufferInfo(buffer.m_buffer, 0, sizeof(u32));
    ...
    return std::make_shared<MaterialInstance>(this, set);
}
} // namespace Pinut
