...
struct DrawCall
{
    ...
    void SetUniformBuffer(GPUBuffer buffer, ShaderType shaderType, u32 binding, u32 set = 0);
    void SetUniformBuffer(const std::string& name, ShaderType shaderType, GPUBuffer buffer);
